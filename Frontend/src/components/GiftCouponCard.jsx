    ...
    return (
        ...
        >
            <div className='space-y-4'>
                <div>
                    ...
                    <input
                        type='text'
                        id='voucher'
                        className=' relative z-10 pointer-events-auto block w-full rounded-lg border border-gray-600 bg-gray-700 
            ...
            focus:ring-emerald-500'
                ...
                <motion.button
                    type="button"
                    className="relative z-10 flex w-full items-center justify-center rounded-lg 
            ...
            {isCouponApplied && coupon && (
                <div className='mt-4'>
                    ...
                    <motion.button
                        type="button"
                        className="relative z-10 mt-2 flex w-full items-center justify-center rounded-lg 
